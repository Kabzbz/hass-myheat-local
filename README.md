...
Выбег насоса после погасания пламени как работа горелки не считается. Опрос раз в 15 с может не заметить очень короткое открытие крана (5–10 с) — если это важно, поставьте опрос 5–10 с.
